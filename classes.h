...
enum parameters {ELEMENT_LENGTH,UNKNOW_T,UNKNOW_K,UNKNOW_LAMBDA,UNKNOW_U,UNKNOW_W,UNKNOW_ALFA,UNKNOW_S,UNKNOW_N};
...
class mesh{
    ...
    public:
        void setParameters(float l,float PARAMETER_T,float PARAMETER_K,float PARAMETER_LAMBDA,float PARAMETER_U,float PARAMETER_W,float PARAMETER_ALFA,float PARAMETER_S,float PARAMETER_N){
            parameters[ELEMENT_LENGTH] = l;
            parameters[UNKNOW_T] = PARAMETER_T;
            parameters[UNKNOW_K] = PARAMETER_K;
            parameters[UNKNOW_LAMBDA] = PARAMETER_LAMBDA;
            parameters[UNKNOW_U] = PARAMETER_U;
            parameters[UNKNOW_W] = PARAMETER_W;
            parameters[UNKNOW_ALFA] = PARAMETER_ALFA;
            parameters[UNKNOW_S] = PARAMETER_S;
            parameters[UNKNOW_N] = PARAMETER_N;
        }
