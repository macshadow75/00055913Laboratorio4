...
void leerMallayCondiciones(mesh &m){
    char filename[14];
    ifstream file;
    float l,T_VAR,K_VAR,LAMBDA_VAR,U_VAR,W_VAR,ALFA_VAR,S_VAR,N_VAR;
    ...
    file >> l >> T_VAR >> K_VAR >> LAMBDA_VAR >> U_VAR >> W_VAR >> ALFA_VAR >> S_VAR >> N_VAR;
    file >> nnodes >> neltos >> ndirich_u >> ndirich_p;

    
    m.setParameters(l,T_VAR,K_VAR,LAMBDA_VAR,U_VAR,W_VAR,ALFA_VAR,S_VAR,N_VAR);
